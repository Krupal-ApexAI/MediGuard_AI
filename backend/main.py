...
try:
    ...
    if os.path.exists(model_path) and os.path.exists(encoder_path):
        ...
        print("[OK] Symptom encoder loaded (ML Model disconnected)")
    else:
        print("[WARNING] Disease prediction model files not found. Run train_model.py first.")
except Exception as e:
    print(f"[ERROR] Failed to load disease prediction model: {e}")
    ...
    if GEMINI_API_KEY and not GEMINI_API_KEY.startswith("your_"):
        ...
        try:
            ...
            if m_name:
                ...
                print(f"[AI] MedGuard AI: Gemini model {m_name} ready.")
            else:
                print("[WARNING] MedGuard AI: No models supporting 'generateContent' were found.")
        ...
        print("[WARNING] MedGuard AI: Gemini API key not found or invalid. Running in demo mode.")
except Exception as e:
    print(f"[WARNING] MedGuard AI: Gemini setup failed: {e}")
    GEMINI_AVAILABLE = False
